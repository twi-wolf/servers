...
httpServer.listen(PORT, '0.0.0.0', () => {
  ...
  setTimeout(() => {
    ...
    if (result.success) {
      console.log('[WINGX] Server 1 started successfully')
    } else {
      console.log(`[WINGX] Server 1 auto-start failed: ${result.error}`)
    }
  }, 3000)
})
